...
local _2amodule_name_2a = "nvim-sexp-edit.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-sexp-edit.aniseed.core"), autoload("nvim-sexp-edit.aniseed.fennel"), autoload("nvim-sexp-edit.aniseed.fs"), autoload("nvim-sexp-edit.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "nvim-sexp-edit.aniseed.macros"
  local filename
  do
