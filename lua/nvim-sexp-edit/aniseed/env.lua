...
local _2amodule_name_2a = "nvim-sexp-edit.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-sexp-edit.aniseed.compile"), autoload("nvim-sexp-edit.aniseed.fennel"), autoload("nvim-sexp-edit.aniseed.fs"), autoload("nvim-sexp-edit.aniseed.nvim")
