...
local _2amodule_name_2a = "nvim-sexp-edit.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-sexp-edit.aniseed.core"), autoload("nvim-sexp-edit.aniseed.fs"), autoload("nvim-sexp-edit.aniseed.nvim"), autoload("nvim-sexp-edit.aniseed.string")
...
local function impl()
  local compiler = require("nvim-sexp-edit.aniseed.deps.fennel")
