...
local _2amodule_name_2a = "nvim-sexp-edit.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-sexp-edit.aniseed.core"), autoload("nvim-sexp-edit.aniseed.env"), autoload("nvim-sexp-edit.aniseed.eval"), autoload("nvim-sexp-edit.aniseed.nvim")
